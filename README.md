...
* Basic probability (coins, dice, number ranges)
...
* Classic problems (Monty Hall, etc.)
...
This repository is **Phase 2** of my AI / ML roadmap:

1. **Phase 1:** Python + Linear Algebra ✅
2. **Phase 2:** Probability & Statistics ⬅️ *current*
